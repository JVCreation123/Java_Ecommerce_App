...
<html>
    ...
    <body>
        ...
        <section id="hero" style="background-image: url('img/watchesbanner.webp'); height: 50vh; width: 100%; background-size: cover;">
        ...
        <section id="product1" class="section-p1">
            ...
            <p>Trending Collection New Smart Watches with Discount Rate</p>
            <div class="pro-container">

                <%
                    int itemId = Integer.parseInt(request.getParameter("catId"));
                ...
                <div class="pro" >
                    ...
                    <a href="AddToCartWatches?pid=<%=ii.getPid()%>"><button class="btn btn-primary cart-click" style="margin-bottom: 12px;">add to cart</button></a>
