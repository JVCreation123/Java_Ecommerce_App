...
//                                String banner = (user == null) ? "<li><a href='login_page.jsp'><span class='fa fa-user-circle'></span> Login</a></li>" : "<li><a id='navbarDropdown' role='button' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false' style='cursor: pointer;'><i class='fa fa-user'> Profile</i></a>  <div class='dropdown-menu' aria-labelledby='navbarDropdown'>     <div class='dropdown-item' href='#!' data-toggle='modal' data-target='#profile-modal'><span class='fa fa-user'></span><b>"+ user.getName()+"</b></div>  <a class='dropdown-item' href='LogoutServlets'><i class='far fa-sign-out'></i> Logout</a></div>  </li>";
            ...
            <div id="mobile">
                <a href="<%=log%>"><i class="far fa-shopping-bag"></i></a>
        ...
        <section id="product1" class="section-p1">
            ...
            <div class="pro-container">
                ...
                <div class="pro">
                    ...
                    <a href="<%=log%>"><i class="fal fa-shopping-cart cart"></i></a>
                </div>
                <%
                    }
                %>
        ...
        <section id="banner" style="  background-image: url('img/banner/b2.jpg');" class="section-m1">
            ...
            <a href="<%=log%>"><button class="normal">Explore More</button></a>
        </section>
        ...
        <section id="sm-banner" class="section-p1">
            <div class="banner-box" style="background-image: url('img/banner/b17.jpg'); min-width: 580px;">
                ...
                <a href="<%=log%>"><button class="white">Learn More</button></a>
            </div>
            <div class="banner-box banner-box2" style="  background-image: url('img/banner/b10.jpg'); min-width: 580px;">
                <h4>Spring/summer</h4>
                <h2>upcomming season</h2>
                <span>The best classic dress is on sele at cara</span>
                <a href="<%=log%>"><button class="white">Collection</button></a>
            </div>
        ...
        <section id="newsletter" class="section-p1 section-m1" style="  background-image: url('img/banner/b14.png');">
            ...
            <div class="form">
                ...
                <a href="<%=log%>"><button class="normal">Sign Up</button></a>
            </div>
        </section>
...
//                String cart = (user != null) ? "checkout.jsp" : "login_page.jsp";
            ...
            <div class="col">
                ...
                <a href="<%=log%>">My Wishlist</a>
                <a href="<%=log%>">Track My Order</a>
                <a href="#">Help</a>
            </div>
