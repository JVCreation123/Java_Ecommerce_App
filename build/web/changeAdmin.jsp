                        ...
                        <div class="card-body  text-center">
                            <form action="ChangeAdminServlet" method="post">
                                <div class="form-group text-left">
                                    ...
                                    <input type="text" name="type" class="form-control" id="exampleInputPassword1" value="Admin" disabled>
                                    <label for="exampleInputPassword1">Enter New Password</label>
                                    <input type="password" name="password12" class="form-control" id="exampleInputPassword1" placeholder="Password" required>
                                    <label for="exampleInputPassword1">OTP</label>
                                    <input type="password" name="otp1" class="form-control" id="exampleInputPassword1" placeholder="OTP" required>
                                </div>
